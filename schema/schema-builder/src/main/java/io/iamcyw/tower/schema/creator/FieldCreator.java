...
import io.iamcyw.tower.schema.helper.IgnoreHelper;
...
public class FieldCreator extends ModelCreator {
    ...
    private static boolean isPossibleField(Direction direction, FieldInfo fieldInfo) {
        return fieldInfo != null && !(direction == Direction.IN && Modifier.isFinal(fieldInfo.flags())) &&
                Modifier.isPublic(fieldInfo.flags()) && !Modifier.isStatic(fieldInfo.flags());
    }
    ...
    private static String getOutputNameForField(Annotations annotationsForThisField, String fieldName) {
        return annotationsForThisField.getOneOfTheseMethodAnnotationsValue(Annotations.QUERY,
                                      ...
                                      .orElse(annotationsForThisField.getOneOfTheseAnnotationsValue(Annotations.QUERY,
                                                                                                    ...
                                                                                                    Annotations.JAVAX_JSONB_PROPERTY,
                                                                                                    Annotations.JACKSON_PROPERTY)
                                                                     .orElse(MethodHelper.getPropertyName(Direction.OUT,
                                                                                                          fieldName)));
    }
    ...
    private static String getInputNameForField(Annotations annotationsForThisField, String fieldName) {
        return annotationsForThisField.getOneOfTheseMethodAnnotationsValue(Annotations.JAKARTA_JSONB_PROPERTY,
                                      ...
                                      .orElse(annotationsForThisField.getOneOfTheseAnnotationsValue(
                                                                             ...
                                                                             Annotations.JAVAX_JSONB_PROPERTY,
                                                                             Annotations.JACKSON_PROPERTY)
                                                                     .orElse(MethodHelper.getPropertyName(Direction.IN,
                                                                                                          fieldName)));
    }
