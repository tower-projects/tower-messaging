...
public interface Configure {
     ...
     */
    Configure configureMessageMonitor(Function<Configuration, BiFunction<Class<?>, String, MessageMonitor<Message<?>>>> messageMonitorFactoryBuilder);

    default Configure configureMessageMonitor(Class<?> componentType, Function<Configuration, MessageMonitor<Message<?>>> messageMonitorBuilder) {
    ...
    default Configure configureMessageMonitor(Class<?> componentType, String componentName, Function<Configuration, MessageMonitor<Message<?>>> messageMonitorBuilder) {
     ...
     * @return the current instance of the Configurer, for chaining purposes
     */
    Configure configureMessageMonitor(Class<?> componentType, String componentName, MessageMonitorFactory messageMonitorFactory);
     ...
     * @return the current instance of the Configurer, for chaining purposes
     */
    Configure configureCorrelationDataProviders(Function<Configuration, List<CorrelationDataProvider>> correlationDataProviderBuilder);
    ...
    /**
     * Registers a command handler bean with this {@link Configure}. The bean may be of any type. The actual command
     ...
     * @return the current instance of the {@link Configure}, for chaining purposes
     */
    Configure registerCommandHandler(Function<Configuration, Object> commandHandlerBuilder);
     ...
     */
    @Deprecated
    default Configure registerCommandHandler(int phase, Function<Configuration, Object> commandHandlerBuilder) {
        return registerCommandHandler(commandHandlerBuilder);
    }

    /**
     * Registers a query handler bean with this {@link Configure}. The bean may be of any type. The actual query
     * handler methods will be detected based on the annotations present on the bean's methods. Message handling
     ...
     * @return the current instance of the {@link Configure}, for chaining purposes
     */
    Configure registerQueryHandler(Function<Configuration, Object> queryHandlerBuilder);
     ...
     */
    @Deprecated
    default Configure registerQueryHandler(int phase, Function<Configuration, Object> queryHandlerBuilder) {
     ...
     * @return the current instance of the {@link Configure}, for chaining purposes
     */
    Configure registerMessageHandler(Function<Configuration, Object> messageHandlerBuilder);
     ...
     * @return the current instance of the Configurer, for chaining purposes
     */
    default Configure configureQueryUpdateEmitter(Function<Configuration, QueryUpdateEmitter> queryUpdateEmitterBuilder) {
     ...
     * @return the current instance of the Configurer, for chaining purposes
     */
    default Configure configureTransactionManager(Function<Configuration, TransactionManager> transactionManagerBuilder) {
        return registerComponent(TransactionManager.class, transactionManagerBuilder);
    }


    /**
     * Register an initialization handler which should be invoked prior to starting this {@link Configure}.
     *
     ...
     * @return the current instance of the Configurer, for chaining purposes
     */
    Configure registerHandlerDefinition(BiFunction<Configuration, Class, HandlerDefinition> handlerDefinitionClass);
