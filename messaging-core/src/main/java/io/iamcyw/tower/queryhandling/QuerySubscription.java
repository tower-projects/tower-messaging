...
class QuerySubscription<R> {
    ...
    /**
     * Retrieve the response type of this subscription as a {@link Type}.
     *
     * @return the response type as a {@link Type} tied to this subscription
     */
    ...
    /**
     * Retrieve the query handler of this subscription as a {@link MessageHandler}.
     *
     * @return the {@link MessageHandler} tied to this subscription
     */
