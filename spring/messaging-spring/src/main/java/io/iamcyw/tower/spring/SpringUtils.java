...
public class SpringUtils {
     ...
     * {@link BeanDefinition} of the given {@code beanName}.
     * Uses a {@link ConfigurableListableBeanFactory} to find the required
     ...
     *
     * @param beanName    A {@link String} for the bean name to check its qualifier for.
     * @param beanFactory A {@link ConfigurableListableBeanFactory} used to
     *                    retrieve information about the given {@code beanName}.
     * @param qualifier   A {@link String} for the {@code qualifier} we trying to match with the qualifier of
