...
public interface MessageHandlingMember<T> {
     ...
     * this method is invoked with {@link Executable} and the message is handled by a method of the
    ...
    default Class<?> declaringClass() {
        return unwrap(Member.class).map(Member::getDeclaringClass)
                .orElseThrow(() -> new UnsupportedOperationException(
                        "This implementation of MessageHandlingMember does not wrap a " + "java.lang.reflect.Member. Please provide a different way of " + "getting 'declaringClass' of this MessageHandlingMember."));
    }
